...
```{r eval=FALSE}
drive_auth("byandell@wisc.edu") do this once to authorize within google drive
...
uhs <- read_sheet("https://docs.google.com/spreadsheets/d/1OZAoqEwHCaTOTpd3pC534-My3lGa0gUt-Hu0LD18cQ0",
                  sheet = "COVID-data") %>%
  rename(
